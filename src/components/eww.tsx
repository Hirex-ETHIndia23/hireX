...
const confetti = {
    light: {
      primary: '4CCCBD', // blue.400
      secondary: 'BEE3F8', // blue.100
    },
  
    dark: {
      primary: '3dab7b', // blue.900
      secondary: '8149d1', // blue.800
    },
  }
...
const ProjectForm = (props: Props) => {  
    const handleSubmit = () =>{
      ...
      const fs = require('fs')
      const JWT = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.._8WZdN0WB-U6KYp_0T2d9kcoe3q0ie7StcJlb1URRZk'
      ...
      return (
        <Flex
          ...
          >
          <Box borderRadius="xl" m={{ base: 5, md: 16, lg: 10 }} p={{ base: 5, lg: 8 }} width={["80%"]}>
            <Box>
                ...
                <Stack
                  ...
                  <Box
                    ...
                    <VStack spacing={5}>
                      ...
                      <FormControl isRequired>
                        <FormLabel>Link to Youtube</FormLabel>
                        <InputGroup>
                          <Input type="text" name="yt" placeholder="" />
                        </InputGroup>
                      </FormControl>
